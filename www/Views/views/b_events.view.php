...
<div class="flex flex-right">
    <a href="/bo/events/new">
        <button class="button button--success mb-l">Ajouter une séance</button>
    </a>
</div>

<section>
    <?php if (empty($events)) : ?>
        <div class="flex-column flex-center flex-middle" style="margin-top: 200px;">
            <h1 class="text-large mb-m faded"><i class="fas fa-inbox"></i></h1>
            <p class="text-medium mb-xl faded text-center">Vous n'avez pas encore ajouté de séances.</p>
        </div>
    <?php else : ?>
        <div class="row">
